...
# Function to get all inputs type,name and value in a form.
...
def vulnerable(response):
    errors = {"quoted string not properly terminated",
              ...
              "Server Error","Not Found","Resource Found or Moved ","database","query ","error",
              "syntax error","sql error","sql",
              }
    for error in errors:
...
if __name__ == "__main__":
    print("Example: 'Enter the url : https://www.google.com/' ")
    urlToBeChecked = input("Enter the url :")
